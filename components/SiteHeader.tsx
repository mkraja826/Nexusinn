    ...
    <>
      ...
      <header className="nav site-nav">
        <div className="shell navinner">
          <a href="/" className="logo" aria-label="Nexusinn home"><img src="/nexusinn-logo-transparent.svg" alt="Nexusinn — Innovation, Talent, Impact" style={{display:"block",width:"clamp(185px,19vw,250px)",height:"auto"}} /></a>
